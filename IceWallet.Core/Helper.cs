...
namespace IceWallet
{
    public static class Helper
    {
        ...
        internal static BigInteger SetCompact(this uint nCompact)
        {
            BigInteger i = nCompact & 0x00ffffff;
            if (i < 0x8000)
                i <<= 8;
            i <<= (int)(8 * (nCompact / 0x01000000 - 3));
            return i;
        }
        ...
        {
            return new UInt256(value.ToByteArray().Concat(Enumerable.Repeat((byte)0, 32)).Take(32).ToArray());
        }
    }
}
